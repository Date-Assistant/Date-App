#!/bin/bash
sh /home/it490admin/Projects/Date-App/front-end/scripts/start-up.sh
...
then
	...
	sleep 2
	ssh -t it490admin@$HOST1 "sh /home/it490admin/Projects/Date-App/mariadb/scripts/start-up.sh"
fi
...
then
	...
	sleep 2
	ssh -t it490admin@$HOST2 "sh /home/it490admin/Projects/Date-App/rabbitmq/scripts/start-up.sh"
fi
